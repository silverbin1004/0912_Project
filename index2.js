...
// 8. 아래 코드를 실행하면 어떤 결과가 나오는지 설명하세요. -> 클로저 함수를 통해 inner의 count는 외부 변수를 참조하고 있다. 
//                                                따라서 처음 counter1을 호출 하였을 때는 1이 되고 추가 호출을 하게 되면 2가 된다.
// function outer() {
//     let count = 0;
...
// // 18. 중: 생성자 함수에서 부모 객체의 생성자를 호출하여, 자식 객체가 부모 객체의 속성과 메서드를 물려받게 하는 방법을 설명하세요. 
...
//     greet(){
//         // super.greet();
//         console.log(`Hello, I am ${this.name} and my job title is ${this.jobTitle}`);
//     }
//   }
